...
[sample3,ids3]=processAll('sample',3,[-2,0.1,13]);
[sample2,ids2]=processAll('sample',2,[-2,0.1,13]);
[sample12,ids12]=processAll('sample',12,[-2,0.1,13]);
[sample6,ids6]=processAll('sample',6,[-2,0.1,13]);
[sample4,ids4]=processAll('sample',4,[-2,0.1,13]);
[sample5,ids5]=processAll('sample',5,[-2,0.1,13]);
%%%%%%%%%  1        2       3       4      5         6
