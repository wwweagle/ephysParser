function [out,sequence]= allDualByType(type,classify,binStart,binSize,binEnd,isS1,onlyWellTrain,WJ) %type='odor' or 'correct' ; SampleSize=[PFSampleSize1,PFSampleSize2;BNSampleSize1,BNSampleSize2];
