function out = SampleOpSupp(type,classify,binStart,binSize,binEnd,sampleSize,repeats,onlyWellTrain,ramp) %type='odor' or 'correct' ; SampleSize=[PFSampleSize1,PFSampleSize2;BNSampleSize1,BNSampleSize2];
...
para.setFormat('opsuppress');

out=[];
fl=listF();
if exist('ramp','var') && ramp
    fileList=fl.listOpSupp(true);
else
